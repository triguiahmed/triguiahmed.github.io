...
wts7.versionNumber=wts7.versionNumber||"8.246";wts7.lastPageShow=0;wts7.lastEvent="load";function wtslog7(alias,db,obj,event_name,event_conversion,event){wts7.alias=alias;try{wtslog7Exe(alias,db,obj,event_name,event_conversion,event);}
...
if(!alias||!db){return;}
var start=Date.now();var web_url="www.web-stat.com";var app_url="app.ardalio.com";var app_name="Web-Stat";if(alias!='197785'){if(document.readyState==='loading'){if(typeof document.addEventListener==='function'){document.addEventListener("DOMContentLoaded",function(){wtslog7Exe(alias,db,obj,event_name,event_conversion,event);});return;}
...
timeLastLoad=getData7('tll',alias,gmtimeUnix,rgx)||'0';sessionId=getData7('sid',alias,gmtimeUnix,rgx)||'';userId=wts7.user_id||getData7('uid',alias,gmtimeUnix,rgx)||'';visitorId=getData7('vid',alias,gmtimeUnix,rgx)||'';nVisits=getData7('nv',alias,gmtimeUnix,rgx)||0;isOwner=getData7('io',alias,gmtimeUnix,rgx)||'0';if(isOwner!='1'&&isOwner!='0'){wtsDebug7('1/ bad isOwner : '+isOwner);}
...
return;}
if(document.readyState==='complete'){if(!wts7.pageShowEvent){window.addEventListener("pageshow",function(event){wts7.pageShowEvent=1;wtslog7Exe(alias,db,obj,event_name,event_conversion,event);});}}
else{window.addEventListener("load",function(event){setTimeout(function(){if(!wts7.pageShowEvent){window.addEventListener("pageshow",function(event){wts7.pageShowEvent=1;wtslog7Exe(alias,db,obj,event_name,event_conversion,event);});}},1500);});}
